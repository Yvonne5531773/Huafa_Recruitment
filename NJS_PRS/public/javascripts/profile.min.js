    ...
    $(function() {
        ...
        $("#basicInfo .c_edit").bind("click", function () {
            var a = $("#nameVal").val(),
                ...
                g = $("#telVal").val();
            $("#name").val(a),
                $("#nation").val(nationVal).css("color", "#333"),
                ...
                $("#workyear").val(d),
                $("#select_workyear").val(d).css("color", "#333"), "" != e && ($("#currentState").val(e),
            ...
            $("#profileForm").validate({
                ...
                submitHandler: function (a) {
                    var b = $('input[name="name"]', a).val(),
                        ...
                        birthed = $('input[name="birthed"]:checked', a).val(),
                    ...
                    $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                        ...
                        if(b.success) {
                            if ("/resume/myresume.html" == b.content.url)
                                window.location.href = ctx + b.content.url;
                            else {
                                c = b.content.resume;
                                d = c.workYear;
                                "应届毕业生" != d ? (d += "工作经验", $("#workExperience h2 span").text("（投递简历时必填）")) : $("#workExperience h2 span").text(""), e = c.name, "" != c.gender && (e += " | " + c.gender), "" != c.highestEducation && (e += " | " + c.highestEducation), e += " | " + d + "<br />" + c.phone + " | " + c.email + "<br />" + c.status, $(".collapsible_menu dt").html(c.name + "<i></i>"), $("#basicInfo .basicShow span").html(e).parent().removeClass("dn"), $("#basicInfo .basicEdit").addClass("dn"), $("#basicInfo .c_edit").removeClass("dn"), $("#nameVal").val(c.name), $("#nationVal").val(c.nation), $("#genderVal").val(c.gender), $("#topDegreeVal").val(c.highestEducation), $("#workyearVal").val(c.workYear), $("#currentStateVal").val(c.status), $("#emailVal").val(c.email), $("#telVal").val(c.phone), $("#lastChangedTime span").text(b.content.refreshTime), b.content.isNew && changeAllIds(b.content.jsonIds), scoreChange(b.content.infoCompleteStatus.score), k($("#basicInfo"))
                            }
                        }else {
                            alert(b.msg);
